...
import kantoorFoto from "@/assets/kantoor.png";
import mrBissessurStanding from "@/assets/mr-bissessur-standing.png";
      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="relative">
            <div className="aspect-[3/4] bg-gradient-to-br from-primary/10 to-primary/5 rounded-lg overflow-hidden shadow-elegant">
              <img 
                src={mrBissessurStanding} 
          ...
          <div className="space-y-6">
            {/* Office Photo */}
            <div className="aspect-[16/9] rounded-lg overflow-hidden shadow-elegant">
              <img 
                src={kantoorFoto} 
                alt="Advocatenkantoor Bissessur - Weimarstraat 227, Den Haag" 

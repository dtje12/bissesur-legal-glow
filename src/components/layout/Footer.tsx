      ...
      <div className="border-t border-primary-foreground/10">
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center md:justify-end gap-x-6 gap-y-2 text-center">
              {siteConfig.footerLinks.map((link) => (
                <Link
                  key={link.path}
                  to={link.path}
                  className="text-sm text-primary-foreground/60 hover:text-primary-foreground transition-colors sm:whitespace-nowrap"
                >
                  {link.label}
                </Link>
              ))}
